          ...
          >
            ...
            <div className="space-y-6">
              {reasons.map((reason, index) => (
                ...
                >
                  {/* Icon Glass Box */}
                  <div className="flex-shrink-0 w-12 h-12 bg-white/[0.05] backdrop-blur-md border border-white/10 rounded-lg flex items-center justify-center">
                    <reason.icon className="text-[#ff3b3b]" size={24} />
                  </div>
